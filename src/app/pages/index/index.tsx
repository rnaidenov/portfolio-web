  ...
  return (
    <div className={`${isNavHovered ? 'bg-wenge text-raisin-black' : 'bg-raisin-black'} w-full h-screen flex flex-col items-center justify-center text-center ${smoothTransitionClass}`} ref={indexRef}>
      <div className="relative">
        <div>
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold font-vt323 mb-2">
            Radoslav Naydenov
          </h1>
          <p className="text-sm uppercase">Full-stack dev</p>
        </div>

        <NavMenu onMouseOver={setIsNavHovered} />
      </div>

      <div className="absolute uppercase w-full bottom-0 left-0 pb-4 px-8 flex justify-between items-end">
